...
#include "../../seqmentdrawer/UI/userinterface.hpp"
...
static const qt_meta_stringdata_UserInterface_t qt_meta_stringdata_UserInterface = {
	{
		...
		QT_MOC_LITERAL(1, 14, 10), // "newsegment"
		QT_MOC_LITERAL(2, 25, 8), // "newwidth"
		QT_MOC_LITERAL(3, 34, 0) // ""
	},
	"UserInterface\0newsegment\0newwidth\0"
};
...
void UserInterface::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
	if (_c == QMetaObject::InvokeMetaMethod) {
		...
		Q_UNUSED(_t)
			switch (_id) {
			case 0: _t->newsegment();	  break;
			case 1: _t->newwidth();		  break;
			default:;			
			}			
	}					
	Q_UNUSED(_a);
